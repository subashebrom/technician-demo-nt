...
/* === REVIEW SLIDES === */
function slieOne_left(){
    document.querySelector('.bxslider-three').style.display = 'flex'
    document.querySelector('.bxslider').style.display = 'none'
}
function slideOne_right(){
    document.querySelector('.bxslider-two').style.display = 'flex'
    document.querySelector('.bxslider').style.display = 'none'
}
function slideTwo_left(){
    document.querySelector('.bxslider-two').style.display = 'none'
    document.querySelector('.bxslider').style.display = 'flex'
}
function slideTwo_right(){
    document.querySelector('.bxslider-two').style.display = 'none'
    document.querySelector('.bxslider-three').style.display = 'flex'
}
function slideThree_left(){
    document.querySelector('.bxslider-two').style.display = 'flex'
    document.querySelector('.bxslider-three').style.display = 'none'
}
function slideThree_right(){
    document.querySelector('.bxslider').style.display = 'flex'
    document.querySelector('.bxslider-three').style.display = 'none'
}
